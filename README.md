...
- **Fedora / RPM-based:**
  ...
  ```bash
  sudo dnf install ./ayuz-1.1.3-1.x86_64.rpm
  ```

- **Debian / Ubuntu / DEB-based:**

  ```bash
  sudo apt install ./ayuz_1.1.3-1_amd64.deb
  ```

- **AppImage (any distribution):**
  ```bash
  chmod +x ayuz-1.1.3-1.AppImage
  ./ayuz-1.1.3-1.AppImage
  ```
...
cargo appimage
./target/appimage/ayuz-1.1.3-1.AppImage
```
